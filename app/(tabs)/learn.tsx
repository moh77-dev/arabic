    ...
    <View style={{ flex: 1, backgroundColor: theme.background }}>
      ...
      >
        ...
        <Text style={{ color: theme.textSecondary, fontSize: 13, marginTop: 2 }}>
          {meta.name} · {doneLessons}/{totalLessons} lessons
        </Text>
                  ...
                  {unit.lessonIds.map((lessonId, i) => {
                    ...
                    return (
                      <PathNode
                        ...
                        label={lesson.title}
                        sublabel={isCurrent ? `${lesson.estimatedMinutes} min · +${lesson.xpReward} XP` : undefined}
  ...
  return (
    <View style={{ transform: [{ translateX: offset }], alignItems: 'center' }}>
      {isCurrent && (
        ...
        >
          <Text style={{ color: theme.primaryText, fontWeight: '900', fontSize: 10, letterSpacing: 0.6 }}>START</Text>
        </View>
      )}
      <AnimatedPressable
        onPress={onPress}
