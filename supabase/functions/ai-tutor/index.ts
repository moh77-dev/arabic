  ...
  try {
    ...
    if (body.mode === 'grammar') {
      ...
      const result = await chatCompleteJSON<{
        ...
        system: `You are Lahja's Arabic grammar tutor, an expert Arabic linguist specializing in the "${dialectId}" dialect. Explain grammar clearly, simply, and encouragingly for a language learner. Always give 2-4 concrete examples in that dialect.`,
