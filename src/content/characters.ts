...
export const AI_CHARACTERS: AIConversationCharacter[] = [
  ...
  },
  {
    ...
    avatar: '🎓',
    dialectId: 'algerian_constantine',
    personality: 'Studious but social, mixes French and Arabic, talks about exams and campus life.',
    voiceId: 'constantine_female_young',
    difficulty: 3,
    conversationGoals: ['Ask about her studies', 'Talk about campus life', 'Ask to study together'],
    systemPromptSeed: 'You are Nour, a university student in Constantine who code-switches between French and Darja and talks about exams and student life.',
    isPremium: true,
  },
  {
  ...
  },
  {
    ...
    avatar: '🏨',
    dialectId: 'algerian_oran',
    personality: 'Professional, welcoming, helps with bookings and local tips.',
    voiceId: 'oran_female_young',
    difficulty: 2,
    conversationGoals: ['Check in', 'Ask about amenities', 'Request local recommendations'],
    systemPromptSeed: 'You are Lina, a friendly hotel receptionist in Oran who helps guests check in and offers local recommendations.',
    isPremium: true,
  },
];
